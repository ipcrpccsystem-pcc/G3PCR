...
<div class="main-content">
  <div class="page-header">
    ...
    <div class="page-actions">
      <button class="btn btn-danger" id="emptyBinBtn" <?= count($deletedSubmissions) == 0 ? 'disabled' : '' ?>>
        <i class="fas fa-trash me-2"></i> Empty Recycle Bin
      </button>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <form method="GET" class="d-flex">
          ...
          <input type="text" name="search" class="form-control me-2" placeholder="Search by name, department, or period..." value="<?= htmlspecialchars($search) ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Empty Recycle Bin</h5>
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-warning">
          ...
          This will permanently delete <?= count($deletedSubmissions) ?> submissions.
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger" id="confirmEmptyBin">Empty Recycle Bin</button>
      </div>
    </div>
  </div>
</div>
...
<script>
    ...
    const emptyBinModal = new bootstrap.Modal(document.getElementById('emptyBinModal'));
    const confirmEmptyBin = document.getElementById('confirmEmptyBin');
    
    emptyBinBtn.addEventListener('click', function() {
        emptyBinModal.show();
    });
    
    confirmEmptyBin.addEventListener('click', function() {
        fetch('empty_recycle_bin.php', {
            method: 'POST',
            headers: {
