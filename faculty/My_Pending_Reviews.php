...
// Get pending submissions for this faculty member
 $stmt = $conn->prepare("SELECT * FROM ipcr_submissions WHERE faculty_id = ? AND status = 'Pending' ORDER BY created_at DESC");
...
<head>
    <meta charset="UTF-8">
    <title>My Pending Reviews - IPCR</title>
    ...
    <div class="card">
        <div class="card-header bg-white py-3">
            <div class="row align-items-center">
                <div class="col">
                    <h5 class="mb-0">My Pending IPCR Reviews</h5>
                </div>
                <div class="col-auto">
                    <span class="badge bg-warning"><?= count($submissions) ?> Pending Reviews</span>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <h5>No pending reviews found</h5>
                    <p class="text-muted">All your IPCR submissions have been reviewed.</p>
